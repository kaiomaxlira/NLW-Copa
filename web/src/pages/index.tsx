    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <h1 className="mt-14 text-white text-5xl font-bold leading-tight">
          Crie seu própio bolão de copa e compartilhe entre amigos!</h1>
        ...
        <p className="mt-4 text-ms text-gray-300 leading-relaxed"> Após criar bolão, você receberá um código único que poderá usar para convidar outras pessoas </p>

        <div className="mt-10 pt-10 border-t border-gray-600 flex items-center justify-between text-gray-100">
          <div className="flex items-center gap-6">
            <Image src={iconCheckImg} alt="" />
            <div className="flex flex-col">
            <span className="font font-bold text-2xl">+{props.poolCount}</span>
          ...
          <div className="flex items-center gap-6">
            <Image src={iconCheckImg} alt="" />
            <div className="flex flex-col">
            <span className="font font-bold text-2xl">+{props.guessCount}</span>
